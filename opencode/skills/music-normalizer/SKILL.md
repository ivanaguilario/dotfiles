...
- Audit music library artist directories, album directories, and track files against a strict canonical naming convention.
- Build conservative rename plans for artist, album, track, and cover-image names.
- Apply safe renames only when explicitly instructed.

## When to use me

Use this skill when the user wants to audit or safely normalize a music collection's folder and track naming.

## Default behavior

- Audit only.
- Do not rename anything unless the user explicitly asks to apply renames.
